...
function showPopup(meal) {
  ...
  popUp.innerHTML = `
    <div class="w-4/5 md:w-3/5 h-48 md:h-auto absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 items-center overflow-y-scroll md:overflow-y-auto">
